...
header <- ggplot()+
  labs(title = "Video Games Played in the Last Two Weeks",
       ...
       and It seems that Most of the Games with longest Average playtime released in recent years",
                           width = 100))+
    theme(plot.title = element_text(size = 25,margin = margin(t = 3,b =1,unit = "mm")),
          plot.subtitle = element_text(family = "Roboto Mono", size = 16))
...
png("Video_Games-01.png", width = 1500, height = 700, res = 144, bg = "transparent")
